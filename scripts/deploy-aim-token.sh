#!/bin/bash
  ...
  echo "Please update configure-issuer.py, create-trust-line.py, and issue-vibe-token.py with the issuer seed and test wallet address."
  ...
  python3 scripts/issue-vibe-token.py

  deactivate

  echo "VIBE token issuance completed"
