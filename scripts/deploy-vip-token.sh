...
echo "Please update configure-issuer.py, create-trust-line.py, and issue-vip-token.py with the issuer seed and test wallet address."
...
python3 scripts/issue-vip-token.py

deactivate

echo "VIP token issuance completed"
